namespace Catalog.API.Models.Products.UpdateProduct
{
    public record UpdateProductCommand(Guid Id, string Name, List<string> Category,
        string Description, string ImagesFiles, decimal Price):
        ...
        : ICommandHandler<UpdateProductCommand, UpdateProductResult>
    {
        ...
        {
            logger.LogInformation("UpdateProeucHandle.Handle llamado con {@Command}", command);
            ...
            product.ImagesFiles = command.ImagesFiles;
